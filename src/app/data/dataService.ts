...
class DataService {
  ...
  getAllClusters(): Cluster[] {
    return this.data.openshift.clusters;
  }
  ...
  getAllProjects(): Project[] {
    return this.data.openshift.projects;
  }

  getProjectsByClusterId(clusterId: string): Project[] {
    return this.data.openshift.projects.filter(p => p.clusterId === clusterId);
  }

  getProjectById(projectId: string): Project | undefined {
    return this.data.openshift.projects.find(p => p.id === projectId);
  }
  ...
  getAWSAccounts(): AWSAccount[] {
    return this.data.aws.accounts;
  }

  getAWSAccountById(accountId: string): AWSAccount | undefined {
    return this.data.aws.accounts.find(a => a.id === accountId);
  }
  ...
  getAzureAccounts(): AzureAccount[] {
    return this.data.azure.accounts;
  }

  getAzureAccountById(accountId: string): AzureAccount | undefined {
    return this.data.azure.accounts.find(a => a.id === accountId);
  }
